...
* borders not visible in light themes ([#525](https://github.com/Sumabhat11/nixopus/issues/525)) ([8756ff7](https://github.com/Sumabhat11/nixopus/commit/8756ff7e1b81672df98670e2f592ca73b4adab98))
* security scan to have TRIVY_DISABLE_VEX_NOTICE ([43546b8](https://github.com/Sumabhat11/nixopus/commit/43546b88b507aa776e2260d24a1ac68594630fe0))


### Features

* add custom domain support for templates ([956e889](https://github.com/Sumabhat11/nixopus/commit/956e8892db6736b5c70b4099497612a828d2369e))
* add proxy support for extensions ([88ce1bc](https://github.com/Sumabhat11/nixopus/commit/88ce1bcaded066ad8f906f03731e1f3ea925f908))
* **cli:** bump cli v0.1.15 to v0.1.16 ([#529](https://github.com/Sumabhat11/nixopus/issues/529)) ([0db449b](https://github.com/Sumabhat11/nixopus/commit/0db449b5fa5b8235fffe12b09b3dbdcfaecccf9a))
* **cli:** live reloading dockerized dev setup ([#522](https://github.com/Sumabhat11/nixopus/issues/522)) ([a05a0d6](https://github.com/Sumabhat11/nixopus/commit/a05a0d658ba42284404e0e72d930630abd5a74d1))
* nixopus update ([#401](https://github.com/Sumabhat11/nixopus/issues/401)) ([3913d60](https://github.com/Sumabhat11/nixopus/commit/3913d60a1566f86a71407103417ce5fabd35a086))
* setup development environment with cli installer ([#508](https://github.com/Sumabhat11/nixopus/issues/508)) ([a3647c6](https://github.com/Sumabhat11/nixopus/commit/a3647c6f47bc2a75b1367a146a13ed143daedfa6))
* **terminal:** support clipboard for terminal input/output ([#515](https://github.com/Sumabhat11/nixopus/issues/515)) ([8ad6a1c](https://github.com/Sumabhat11/nixopus/commit/8ad6a1c08c64eebfbfad5c83bd506ce8bc3fd508))



# [0.1.0-alpha.41](https://github.com/Sumabhat11/nixopus/compare/93187f3e6b34a5df7e7d5677ef64dec4608bcd2c...v0.1.0-alpha.41) (2025-10-16)
...
* **cli:** force HTTP protocol for SuperTokens connection URI ([#487](https://github.com/Sumabhat11/nixopus/issues/487)) ([eb2c0dd](https://github.com/Sumabhat11/nixopus/commit/eb2c0ddb9e3df80e606933082a92a66ef65c24cd))
...
* env config for psql setup with supertokens ([#483](https://github.com/Sumabhat11/nixopus/issues/483)) ([5e8db05](https://github.com/Sumabhat11/nixopus/commit/5e8db05b8c4b20b729952a79f6c1edbff32bf6db))
...
* login with ip address deployments ([da08719](https://github.com/Sumabhat11/nixopus/commit/da08719306bb821bbbc5999c6328de0833c1b575))
...
* remove custom marker ([e8a930f](https://github.com/Sumabhat11/nixopus/commit/e8a930f3bd2a0e40f84aa8b917153aa4b2012a5b))
...
* **staging-compose:** remove test db service, and change staging docker network to nixopus-staging-network ([7560efb](https://github.com/Sumabhat11/nixopus/commit/7560efb2534aa952dd70362a94fae8faa2a289bf))
...
* uses port decoupled installation script which loads ports and configs from a sepecific config.json file from the helpers/config.json ([f28d520](https://github.com/Sumabhat11/nixopus/commit/f28d5200aea74961b85f54aa67062f290c5fec3e))
...
* container listing with pagination, search, and sort ([#367](https://github.com/Sumabhat11/nixopus/issues/367)) ([7400fda](https://github.com/Sumabhat11/nixopus/commit/7400fdae767468a44062eb05468349cfa149219c))
...
* **file-manager:** improve resposiveness of file manager ([4da64a7](https://github.com/Sumabhat11/nixopus/commit/4da64a7fc9e0fd6bd177455ba7fe47a404da265d))
...
* **release-workflow:** debug release workflow ([6551769](https://github.com/Sumabhat11/nixopus/commit/655176948365d90e4c4bab4e4243fe0238e9bd59))
