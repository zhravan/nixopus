...
func TestValidateRequest(t *testing.T) {
	...
	// Test Invalid LogoutRequest
	invalidLogoutReq := &types.LogoutRequest{
		RefreshToken: "",
	}
	if err := validator.ValidateRequest(invalidLogoutReq); err == nil {
		t.Errorf("Expected error for invalid logout request, got nil")
	}
