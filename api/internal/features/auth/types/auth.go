...
var (
	...
	ErrFailedToCreateDefaultRoles                 = errors.New("failed to create default roles")
	ErrFailedToAddDefaultPermissionsToDefaultRole = errors.New("failed to add default permissions to default roles")
