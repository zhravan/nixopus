...
func (c *RolesController) parseAndValidate(w http.ResponseWriter, r *http.Request, req interface{}) bool {
...
func (c *RolesController) GetUser(w http.ResponseWriter, r *http.Request) *shared_types.User {
