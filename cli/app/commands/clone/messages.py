...
path_exists_prompt = "Directory {path} already exists and contains data that will be PERMANENTLY DELETED. Do you want to continue with --force flag to overwrite it?"
installation_cancelled_by_user = "Installation cancelled by user"
