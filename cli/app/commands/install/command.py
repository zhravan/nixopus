...
def install_callback(
    ...
    no_verify_health: bool = typer.Option(False, "--no-verify-health", help="Skip health checks after starting services (not recommended)"),
    ...
    if ctx.invoked_subcommand is None:
        ...
        params = InstallParams(
            ...
            verify_health=not no_verify_health,
