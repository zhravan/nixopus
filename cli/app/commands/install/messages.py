...
rollback_starting = "Starting rollback to clean system state..."
rollback_completed = "Rollback completed successfully"
rollback_failed = "Some rollback steps failed"
services_health_check_timeout = "Service health check timed out after {timeout} seconds"
services_unhealthy = "Some services failed to become healthy"
services_health_check_failed = "Health check failed"
verifying_service_health = "Verifying service health"
all_services_healthy = "All services are healthy"
service_health_status = "Service {service}: {status}"
