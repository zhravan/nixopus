...
<template>
  <div class="validation-item" :class="error.type">
    ...
    <svg v-else-if="error.type === 'info'" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <circle cx="12" cy="12" r="10"></circle>
    ...
    <button
      ...
      class="dismiss-btn"
      @click="$emit('dismiss', error.message)"
      title="Dismiss"
    >
