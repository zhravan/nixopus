...
var Popover = (_a) => {
  ...
  const autoPosition = (coords, outX, outY) => {
    const positionsOrder = (0, import_utils.bestPositionOf)(
      available,
  ...
  const pos = (helperPosition) => {
    ...
    const isHelperOutsideX = (0, import_utils.isOutsideX)(targetLeft + helperWidth, windowWidth);
    const isHelperOutsideY = (0, import_utils.isOutsideY)(
