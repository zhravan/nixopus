...
var import_mask = require("@reactour/mask");
...
function useSizes(step, scrollOptions = {
  ...
  (0, import_react.useEffect)(() => {
    const isInView = (0, import_utils.inView)(__spreadProps(__spreadValues({}, dimensions), {
...
function getHighlightedRect(node, highlightedSelectors = [], bypassElem = true) {
  ...
  if (!highlightedSelectors) {
    return __spreadProps(__spreadValues({}, (0, import_utils.getRect)(node)), {
      windowWidth,
      windowHeight,
      hasHighligtedElems: false
    });
  }
  let attrs = (0, import_utils.getRect)(node);
  let altAttrs = {
    bottom: 0,
    height: 0,
    left: windowWidth,
  ...
  for (const selector of highlightedSelectors) {
    ...
    const rect = (0, import_utils.getRect)(element);
