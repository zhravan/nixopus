      ...
      if (v.is_required) {
        ...
        if (v.variable_type === 'string' || v.variable_type === 'array') {
          if (v.variable_type === 'string') {
            if (!val || (typeof val === 'string' && val.trim() === '')) nextErrors[v.variable_name] = 'Required'
        ...
        if (v.variable_type === 'integer') {
          if (val === '' || val === undefined || val === null || Number.isNaN(val)) nextErrors[v.variable_name] = 'Required'
        }
      }
    })
