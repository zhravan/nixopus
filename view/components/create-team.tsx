...
export function CreateTeam({ open, setOpen, createTeam, teamName, teamDescription, handleTeamNameChange, handleTeamDescriptionChange, isLoading }: CreateTeamProps) {
    return (
