...
import { PanelLeftIcon, ChevronLeft, ChevronRight, Menu } from 'lucide-react';
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'peer-data-[variant=inset]:h-full md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2',
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-bold data-[active=true]:text-sidebar-accent-foreground data-[active=true]:[&>svg]:stroke-[3.5] data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      ...
      size: {
        default: 'h-8 text-sm data-[active=true]:text-sm',
        sm: 'h-7 text-xs data-[active=true]:text-xs',
        lg: 'h-12 text-sm data-[active=true]:text-sm group-data-[collapsible=icon]:p-0!'
      }
    },
    defaultVariants: {
      variant: 'default',
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'data-[active=true]:bg-sidebar-accent data-[active=true]:font-bold data-[active=true]:text-sidebar-accent-foreground data-[active=true]:[&>svg]:stroke-[3.5]',
        size === 'sm' && 'text-xs data-[active=true]:text-xs',
        size === 'md' && 'text-sm data-[active=true]:text-sm',
        'group-data-[collapsible=icon]:hidden',
        className
      )}
      {...props}
