...
const domainLoaders: Record<string, Record<string, () => Promise<any>>> = {
  en: {
    ...
    integrations: () => import('@/lib/i18n/locales/en/integrations.json'),
  ...
  es: {
    ...
    integrations: () => import('@/lib/i18n/locales/es/integrations.json'),
  ...
  fr: {
    ...
    integrations: () => import('@/lib/i18n/locales/fr/integrations.json'),
  ...
  kn: {
    ...
    integrations: () => import('@/lib/i18n/locales/kn/integrations.json'),
  ...
  ml: {
    ...
    integrations: () => import('@/lib/i18n/locales/ml/integrations.json'),
