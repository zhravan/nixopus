...
import NetworkWidget from '@/app/dashboard/components/system/network';
import LoadAverageCard from '@/app/dashboard/components/system/load-average';
import CPUUsageCard from '@/app/dashboard/components/system/cpu-usage';
